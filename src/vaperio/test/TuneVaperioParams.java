...
import vaperio.design.VaperioGameSearchSpace;

// import ntuple.NTupleBanditEA;

public class TuneVaperioParams {
...
//            runner.setLineChart(lineChart);
        ...
        runner.plotChecks = 0;
        AnnotatedFitnessSpace vaperioGameSearchSpace = new VaperioGameSearchSpace();
        // uncomment to run the skilful one
        // caveSwingSpace = new CaveSwingGameSkillSpace();
        System.out.println("Testing: " + ntbea);
        runner.runTrials(ntbea, vaperioGameSearchSpace);
